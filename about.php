        ...
        <div class="inner customScroll">
            ...
            <div class="offcanvas-menu">
                <ul>
                    ...
                    <li><a href="shop-left-sidebar.php"><span class="menu-text">Shop</span></a></li>
            ...
            <div class="row">
                <div class="col-lg-6" style="display: flex; justify-content:center; align-items:center;">
                    <div class="about-left-image mb-md-30px mb-lm-30px">
                        <img loading="lazy" src="  <?php echo $img_link ?>images/slider-image/sample-4.jpg" alt="" class="img-responsive" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="about-title">
                            <h2>Welcome To Dank Thrift</h2>
                        </div>
                        <p class="mb-30px">
                        ...
                        <p style="font-size: 1rem;">
                            Fast fashion is an inexpensive and quick way of producing clothes, but it can have devastating effects on the environment. The fast fashion industry produces globally 20% of wastewater. Textile dyeing is the second largest water polluter globally.7600 liters of water Is needed to produce a single pair of jeans.
                        </p><br>
                        <p style="font-size: 1rem;">
                            The fast fashion industry produces 10% of global carbon emissions. Every second The equivalent of one garbage truck full of textiles is burned or landfilled. It takes 200 years for some materials to break down. During this process, toxic gases and chemicals are emitted into the atmosphere, or filtered into the soil and groundwater, harming the environment.
                        </p>
                        </p>
                    </div>
                </div>
