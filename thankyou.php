...
<head>
    <meta charset="utf-8">
    <title>Checkout Successful - Thank you for purchasing at Dank Thrift</title>
    <meta name="description" content="Thank you for purchasing from Dank Thrift, if you have any questions relating to your purchase or want to track the status of your order contact us at +91-81712 80077">
    ...
    <meta property="og:title" content="Checkout Successful - Thank you for purchasing at Dank Thrift" />
    <meta property="og:url" content="<?php echo $actual_link ?>" />
    <meta property="og:description" content="Thank you for purchasing from Dank Thrift, if you have any questions relating to your purchase or want to track the status of your order contact us at +91-81712 80077">
...
<body>
    ...
    <input type="hidden" id="invoice" value='<?php echo $_SESSION['invoice']; ?>'>
    <input type="hidden" id="invoice-mobile" value='<?php echo $_SESSION['invoice']; ?>'>
    <!-- --------------------------- header start here --------------------------- -->
                ...
                <div class="col-md-12">
                    <div class="row shadow p-4">
                        <div class="col-lg-5 col-md-12 col-sm-12 d-flex justify-content-center">
                            <img loading="lazy" src="images/cart.png" alt="" class="img-responsive" style="filter:drop-shadow(0px 0px 5px rgba(0,0,0,0.2));">
                        </div>
                        <div class="col-lg-7 col-md-12 col-sm-12">
                            <div class="text-center">
                                <i class="ion ion-checkmark-circled" style="font-size: 5rem;color:#3282ea"></i>
                                <h1 class="my-2">Thank You!</h1>
                                <p class="p-1 title-desc text-muted my-2">Please expect your Package to arrive within 7 Working Days, Meanwhile Please have a Look at</p>
                                <h5>Your Order id is :</h5>
                                <h4 class="mt-2 booking_id my-2" style="font-weight: 700;color:#3282ea;text-transform:uppercase;"><?php echo $_SESSION['order_id'] ?></h4>
                            </div>
                            <div class="row d-flex justify-content-center">
                                <div class="mt-3">
                                    <button class="btn cv" id="download" style="font-size: 14px;">Download Invoice</button>
                                </div>
    ...
    <script>
        ...
        window.onload = function() {
            document.getElementById("download").addEventListener("click", () => {
                const invoice = this.document.getElementById("invoice").value;
                // console.log(invoice);
                // console.log(window);
                var opt = {
                    margin: 0.5,
