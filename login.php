...
// $_SESSION['visited_page']='';
//  $_SESSION['visited_page']=$_SERVER['HTTP_REFERER'];
//  $_SESSION['my']=$_SESSION['visited_page'];
//   echo $_SESSION['visited_page'];
...
<body>
    ...
    <!-- -------------------------- last visit page start ------------------------- -->

    <input type="hidden" value="<?php echo $_SERVER['HTTP_REFERER'] ?>" id="last_visited_page">
    <!-- -------------------------- last visit page end ------------------------- -->
    <!-- --------------------------- header start here --------------------------- -->
                        ...
                        <div class="tab-content">
                            <div id="lg1" class="tab-pane active">
                                <div class="login-form-container">
                                    <p class="mb-5 text-center" style="color: red;display:none" id="error_login">*</p>
                                    <div class="login-register-form" id="login_tab">
                                        <form method="post">
                                            <input name="email" placeholder="Email" type="email" id="user_email_login">
                                            <input type="password" name="user-password" placeholder="Password" id="user_password_login">
                                            <div class="button-box">
                                                <div class="login-toggle-btn">
                                                    <!-- <input type="checkbox">
                                                <a class="flote-none" href="javascript:void(0)">Remember me</a> -->
                                                    <a style="cursor:pointer;" id="forgot_btn">Forgot Password?</a>
                                                </div>
                                                <button type="button" id="LoginForm"><span>Login</span></button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="login-register-form" style="display:none;" id="forgot_tab">
                                        <form method="post">
                                            <input name="email" placeholder="Email" type="email" id="email_forgot">
                                            <input type="password" name="forgot-password" placeholder="Password" id="password_forgot">
                                            <input type="password" name="forgor-confirm-password" placeholder="Confirm Password" id="confirm_password_forgot">
                                            <div class="button-box">
                                                <div class="login-toggle-btn">
                                                    <!-- <input type="checkbox">
                                                <a class="flote-none" href="javascript:void(0)">Remember me</a> -->
                                                    <a style="cursor:pointer;" id="login_btn">Login ?</a>
                                                </div>
                                                <button type="button" id="ForgotForm"><span>Submit</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div id="lg2" class="tab-pane">
                                <div class="login-form-container">
                                    <p class="mb-5 text-center" style="color: red;display:none" id="error_registration">
                                        *</p>
                                    <div class="login-register-form">
                                        <form method="post">
                                            <input name="email" placeholder="Email" type="email" id="user_email">
                                            <input name="phone" placeholder="Mobile Number" type="text" id="user_phone">
                                            <input type="password" name="password" placeholder="Password" id="user_password">
                                            <input type="password" name="conf-password" placeholder="Confirm Password" id="user_confirm_password">
                                            <div class="button-box">
                                                <button type="button" id="RegisterForm"><span>Register</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
============================================ -->
    ...
    <script>
        ...
        /* ------------------- last visit page functionality start ------------------ */

        var last_visit_page = $('#last_visited_page').val();
        var n = last_visit_page.includes("Undefined index");
        if (n == true) {
            last_visit_page = '/';
            // console.log("/");
        } else {
            last_visit_page = last_visit_page;
            //   console.log(last_visit_page);
        }
        /* ------------------- last visit page functionality end ------------------ */
        $('#RegisterForm').click(function() {
            ...
            if (phone == "") {
                ...
                $("#user_phone").css('border-width', '2px');
                error = error + 'phone';
            } else {
                $("#user_phone").css('border-color', '#C0BBBB');
                $("#user_phone").css('border-width', '1px');
            }
            if (phone.length != 10) {
                $("#user_phone").css('border-color', 'red');
                $("#user_phone").css('border-width', '2px');
            ...
            if (!validateEmail(email)) {
                ...
                $("#user_email").css('border-width', '2px');
                error = error + 'email';
            } else {
                $("#user_email").css('border-color', '#C0BBBB');
                $("#user_email").css('border-width', '1px');
            }
            if (password == "") {
                $("#user_password").css('border-color', 'red');
                $("#user_password").css('border-width', '2px');
                error = error + 'password';
            } else {
                $("#user_password").css('border-color', '#C0BBBB');
                $("#user_password").css('border-width', '1px');
            }
            ...
            if (confirm_password == "") {
                $("#user_confirm_password").css('border-color', 'red');
                $("#user_confirm_password").css('border-width', '2px');
                error = error + 'confirm_password';
            } else {
                $("#user_confirm_password").css('border-color', '#C0BBBB');
                $("#user_confirm_password").css('border-width', '1px');
            }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 201) {
                            ...
                            $('#error_registration').html(data.error);
        ...
        $('#LoginForm').click(function() {
            ...
            if (!validateEmail(email)) {
                ...
                $("#user_email_login").css('border-width', '2px');
                error = error + 'email';
            } else {
                $("#user_email_login").css('border-color', '#C0BBBB');
                $("#user_email_login").css('border-width', '1px');
            }
            if (password == "") {
                $("#user_password_login").css('border-color', 'red');
                $("#user_password_login").css('border-width', '2px');
                error = error + 'password';
            } else {
                $("#user_password_login").css('border-color', '#C0BBBB');
                $("#user_password_login").css('border-width', '1px');
            }
            if (error == "") {
                $.ajax({
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 201) {
                            // if(data.link!=""){
                            window.location.replace(last_visit_page);
                            // }else{
        ...
        $('#forgot_btn').click(function() {
            $('#forgot_tab').css('display', 'block');
            $('#login_tab').css('display', 'none');
            $('#change_text').text('Forgot Password');
        });
        $('#login_btn').click(function() {
            $('#forgot_tab').css('display', 'none');
            $('#login_tab').css('display', 'block');
            $('#change_text').text('Login');
        });
        ...
        $('#ForgotForm').click(function() {
            ...
            var confirm_password = $("#confirm_password_forgot").val();
            ...
            if (!validateEmail(email)) {
                ...
                $("#email_forgot").css('border-width', '2px');
                error = error + 'email';
            } else {
                $("#email_forgot").css('border-color', '#C0BBBB');
                $("#email_forgot").css('border-width', '1px');
            }
            if (password == "") {
                $("#password_forgot").css('border-color', 'red');
                $("#password_forgot").css('border-width', '2px');
                error = error + 'password';
            } else {
                $("#password_forgot").css('border-color', '#C0BBBB');
                $("#password_forgot").css('border-width', '1px');
            }
            if (confirm_password == "") {
                $("#confirm_password_forgot").css('border-color', 'red');
                $("#confirm_password_forgot").css('border-width', '2px');
                error = error + 'password';
            } else {
                $("#confirm_password_forgot").css('border-color', '#C0BBBB');
                $("#confirm_password_forgot").css('border-width', '1px');
            }
            if (password.length < 6) {
                $("#password_forgot").css('border-color', 'red');
                $("#password_forgot").css('border-width', '2px');
