$(function () {
    ...
    //delete deal start
    //delete hot deal on expire start
    $.ajax({
        type: 'POST',
...
const loginButton = document.getElementById('enableEthereumButton');
...
function toggleButton() {
    ...
    if ($('#enableEthereumButton').length) {
...
async function loginWithMetaMask() {
    ...
    setDataAccount(window.userWalletAddress);
...
function setDataAccount(account_id) {
    $.ajax({
        type: 'POST',
        url: 'php/eth_account.php',
        dataType: "json",
        data: {
