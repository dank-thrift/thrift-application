...
if (isset($_GET['sub_category'])) {
    $product_sub_category = $_GET['sub_category'];
} else {
    $product_sub_category = 'all';
}
// $product_sub_category=$params['sub_category'];
if (isset($_GET['page'])) {
    $page = $_GET['page'];
} else {
    $page = 1;
...
if (isset($_GET['category'])) {
    $q = "SELECT * FROM `product_category` WHERE `category`='$product_category'";
} else {
    $q = "SELECT * FROM `product_category` WHERE 1";
}
...
<head>
    ...
    <meta property="og:title" content="The Best Cotton T-shirt for You- Shop from your Favourite Dank Thrift Collection Now" />
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 order-lg-last col-md-12 order-md-first">
                    ...
                    <div class="shop-top-bar d-flex">
                        ...
                        <div class="shop-tab nav d-flex">
                            ...
                            if (isset($_GET['category']) && (!isset($_GET['sub_category']))) {
                                $query = "SELECT * FROM `product_tbl` INNER JOIN `product_category` ON product_tbl.product_category_id=product_category.product_category_id INNER JOIN `product_subcategory` ON product_tbl.product_subcategory_id=product_subcategory.product_subcategory_id WHERE `category`='$product_category'";
                            } else if (isset($_GET['category']) && isset($_GET['sub_category'])) {
                                $query = "SELECT * FROM `product_tbl` INNER JOIN `product_category` ON product_tbl.product_category_id=product_category.product_category_id INNER JOIN `product_subcategory` ON product_tbl.product_subcategory_id=product_subcategory.product_subcategory_id WHERE `category`='$product_category' AND `subcategory`='$product_sub_category'";
                            } else if (!isset($_GET['category']) && isset($_GET['sub_category'])) {
                                $query = "SELECT * FROM `product_tbl` INNER JOIN `product_category` ON product_tbl.product_category_id=product_category.product_category_id INNER JOIN `product_subcategory` ON product_tbl.product_subcategory_id=product_subcategory.product_subcategory_id WHERE `sub_category`='$product_sub_category'";
                            } else {
                                $query = "SELECT * FROM `product_tbl` INNER JOIN `product_category` ON product_tbl.product_category_id=product_category.product_category_id INNER JOIN `product_subcategory` ON product_tbl.product_subcategory_id=product_subcategory.product_subcategory_id WHERE 1";
                            }
                            ...
                            ?>
                            <p>There Are <?php echo $count_number ?> Products.</p>
                        </div>
                        <!-- Left Side End -->
                        <!-- Right Side Start -->
                        <div class="select-shoing-wrap d-flex">
                            ...
                            <div class="shop-select">
                                <select id="sorting">
                                    <option value="product_tbl_time&asc" selected>Sort by newness</option>
                                    <option value="name&asc">A to Z</option>
                                    <option value="name&desc"> Z to A</option>
                                    <option value="product_tbl_time&asc">In stock</option>
                                </select>
                            </div>
                        </div>
                        <!-- Right Side End -->
                    ...
                    <!-- Shop Top Area End -->
                    <input type="hidden" value="<?php echo $product_category ?>" id="product_category">
                    <input type="hidden" value="<?php echo $product_sub_category ?>" id="product_sub_category">
                    ...
                    <div class="shop-bottom-area mt-35">
                        ...
                        <div class="tab-content jump">
                            ...
                            <div id="shop-1" class="tab-pane active">
                                <div class="row m-0" id=example_new>
                        ...
                        <div class="pro-pagination-style text-center mtb-50px">
                            ...
                            <?php
                            if (isset($_GET['category']) && (!isset($_GET['sub_category']))) {
                                $query1 = "SELECT * FROM `product_tbl` INNER JOIN `product_category` ON product_tbl.product_category_id=product_category.product_category_id INNER JOIN `product_subcategory` ON product_tbl.product_subcategory_id=product_subcategory.product_subcategory_id WHERE `category`='$product_category'";
                            } else if (isset($_GET['category']) && isset($_GET['sub_category'])) {
                                $query1 = "SELECT * FROM `product_tbl` INNER JOIN `product_category` ON product_tbl.product_category_id=product_category.product_category_id INNER JOIN `product_subcategory` ON product_tbl.product_subcategory_id=product_subcategory.product_subcategory_id WHERE `category`='$product_category' AND `subcategory`='$product_sub_category'";
                            } else if (!isset($_GET['category']) && isset($_GET['sub_category'])) {
                                $query1 = "SELECT * FROM `product_tbl` INNER JOIN `product_category` ON product_tbl.product_category_id=product_category.product_category_id INNER JOIN `product_subcategory` ON product_tbl.product_subcategory_id=product_subcategory.product_subcategory_id WHERE `sub_category`='$product_sub_category'";
                            } else {
                                $query1 = "SELECT * FROM `product_tbl` INNER JOIN `product_category` ON product_tbl.product_category_id=product_category.product_category_id INNER JOIN `product_subcategory` ON product_tbl.product_subcategory_id=product_subcategory.product_subcategory_id WHERE 1";
                            }
                            ...
                            if (mysqli_num_rows($result1) > 0) {
                                ...
                                if (isset($_GET['category'])) {
                                    if($product_sub_category == '' || $product_sub_category == 'all'){
                                        $link_value = "category=$product_category&";
                                    }else{
                                        $link_value = "category=$product_category&sub_category=$product_sub_category&";
                                    }
                                } else {
                                    $link_value = '';
                                }
                            ...
                            ?>
                                <ul>
                                    <li>
                                        <a class="prev" href="shop-left-sidebar.php?<?php echo $link_value ?>page=<?php if ($page <= 1) {
                                                                                                                        echo ($page);
                                                                                                                    } else {
                                                                                                                        echo ($page - 1);
                                    ...
                                    ?>
                                        <li><a href="shop-left-sidebar.php?<?php echo $link_value ?>page=<?php echo $i ?>" class=<?php echo $active ?>><?php echo $i ?></a></li>
                                    <?php
                                    } 
                                    }?>
                                    <?php
                                    if ($total_page > 3){
                                                    ...
                                                    $afterPage = $page + 1;
                                                    if ($page > 2) {
                                                        echo "<li><a href='shop-left-sidebar.php?{$link_value}page=1'>1</a></li>";
                                                        if ($page > 3) {
                                                            echo "<li><a>...</a></li>";
                                                        }
                                                    }
                                                    ...
                                                    for ($i = $beforePage; $i <= $afterPage; $i++) {
                                                        if ($i > 0 && $i <= $total_page) {
                                                            if ($i == $page) {
                                                                ...
                                                                echo "<li><a href='shop-left-sidebar.php?{$link_value}page={$i}'>{$i}</a></li>";
                                                            }
                                                        }
                                                    }
                                                    ...
                                                    if ($page < $total_page - 1) {
                                                        ...
                                                        echo "<li><a href='shop-left-sidebar.php?{$link_value}page={$total_page}'>{$total_page}</a></li>";
                                                    }

                                                    
                                    }
                                    ?>
                                    <li><a class="next" href="shop-left-sidebar.php?<?php echo $link_value ?>page=<?php if ($page >= $total_page) {
                                                                                                                        echo $page;
                                                                                                                    } else {
                                                                                                                        echo $page + 1;
                ...
                <div class="col-lg-3 order-lg-first col-md-12 order-md-last mb-md-60px mb-lm-60px">
                    <div class="shop-sidebar-wrap">
                        <div class="sidebar-widget mb-30px">
                            <h3 class="sidebar-title"><span><?php echo str_replace("and", "&", $product_category); ?></span></h3>
                            <div class="accordion" id="accordionExample">

                                <!-- card -->
                                <div class="card">
                                    <?php if (isset($_GET['category'])) {
                                        $q = "SELECT subcategory  from `product_subcategory` INNER JOIN `product_category` ON product_category.product_category_id=product_subcategory.product_category_id WHERE category='$product_category'";
                                        $res = mysqli_query($link, $q);
                                        if (mysqli_num_rows($res) > 0) {
                                            while ($row = mysqli_fetch_assoc($res)) {
                                    ?>
                                                <div id="headingTwo" style="font-weight: 400;color: #777;display: block;font-size: 14px;   text-transform: capitalize;margin: 0;padding: 0;border: none;position: relative;transition: all .3s linear;border: 0;padding-left: 0;background: #fff;padding: .75rem 1.25rem;">

                                                    <a href="shop-left-sidebar.php?category=<?php echo $product_category ?>&sub_category=<?php echo $row['subcategory'] ?>" style="color:#777"><?php echo $row['subcategory'] ?></a>
                                        ...
                                        if (mysqli_num_rows($res) > 0) {
                                            ...
                                            ?>
                                                <div class="card-header" id="headingTwo<?php echo $ii ?>">
                                                    <a href="shop-left-sidebar.php?category=<?php echo $row['category']; ?>" class="collapsed" data-toggle="collapse" data-target="#collapseTwo<?php echo $ii ?>" aria-expanded="false" aria-controls="collapseTwo<?php echo $ii ?>"><?php echo $row['category'] ?></a>

                                                </div>

                                                <div id="collapseTwo<?php echo $ii ?>" class="collapse" aria-labelledby="headingTwo<?php echo $ii ?>" data-parent="#accordionExample">
                                                    <div class="card-body">
                                                        <ul class="category-list">
                                                            <?php
                                                            $sub_cate = $row['category'];
                                                            $q1 = "SELECT subcategory  from `product_subcategory` INNER JOIN `product_category` ON product_category.product_category_id=product_subcategory.product_category_id WHERE category='$sub_cate'";
                                                            $res1 = mysqli_query($link, $q1);
                                                            if (mysqli_num_rows($res1) > 0) {
                                                                $i = 0;
                                                                while ($row = mysqli_fetch_assoc($res1)) { ?>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php?category=<?php echo $sub_cate ?>&sub_category=<?php echo $row['subcategory'] ?>"><?php echo $row['subcategory'] ?></a>
                                                                    </li>
                                                            <?php }
                                                            } ?>
                                                        </ul>
                                ...
                                <ul>
                                    <?php if (isset($_GET['category'])) {
                                        ...
                                        if (mysqli_num_rows($res) > 0) {
                                            while ($row = mysqli_fetch_assoc($res)) {
                                    ?>
                                                <li><a href="shop-left-sidebar.php?category=<?php echo $product_category ?>&sub_category=<?php echo $row['subcategory'] ?>"><?php echo $row['subcategory'] ?></a></li><?php }
                                                                                                                                                                                                                }
                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                $q = "SELECT DISTINCT category from `product_category` WHERE 1";
                                                                                                                                                                                                                $res = mysqli_query($link, $q);
                                                                                                                                                                                                                if (mysqli_num_rows($res) > 0) {
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    while ($row = mysqli_fetch_assoc($res)) {
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        ?>
                                                <li><a href=" shop-left-sidebar.php?category=<?php echo $row['category']; ?>"><?php echo $row['category'] ?></a></li>
                                    <?php }
                                                                                                                                                                                                                }
                                                                                                                                                                                                            } ?>
...
============================================ -->
    ...
    <script>
        ...
        /* ---------------------- get value from onchange start --------------------- */
        var product_category = $('#product_category').val();
        var product_sub_category = $('#product_sub_category').val();
        var page = $('#page').val();
        $('#sorting').on('change', function() {
            var sortby = $('#sorting').val();
            call(product_category, sortby, product_sub_category, page)
        });
        call(product_category, "product_tbl_time&asc", product_sub_category, page)

        function call(product_category, sortby, product_sub_category, page) {
            $.ajax({
                type: 'POST',
                ...
                success: function(data) {
                    //  console.log(data);
                    $('#example_new').html(data);

                }
            });
            $.ajax({
                type: 'POST',
                url: 'php/sort_items2.php',
                // dataType: "json",
                data: {
                    'product_category': product_category,
                    'sortby': sortby,
